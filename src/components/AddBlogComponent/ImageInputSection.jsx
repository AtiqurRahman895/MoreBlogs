            ...
            <div className={`container overflow-x-hidden relative ${image?"aspect-auto":"bg-custom-primary aspect-[4/2.5] sm:aspect-[4/1.5]"}`}>
                ...
                <div className="input-box absolute grid justify-items-center content-center top-0 bottom-0 right-0 left-0">
                    ...
                    <label htmlFor="image" className="input-label relative hover:[&_.absolute]:animate-none [&_.absolute]:animate-ping">
                        <MdOutlineAddPhotoAlternate className={`absolute ${image?"text-custom-primary":"text-white "} ![animation-duration:1.5s] text-4xl xs:text-7xl`} />
                        <MdOutlineAddPhotoAlternate className={`${image?"text-custom-primary":"text-white "} text-5xl xs:text-7xl`} />
                    </label>
