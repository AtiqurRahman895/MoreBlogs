        ...
        <footer className="bg-custom-primary pt-20 pb-10">
            <div className="container">
                <div className="footer footer-center text-white gap-14 rounded">
                    ...
                    <h1 className=" font-Sancreek uppercase">More Blogs</h1>
                    ...
                    <aside className="footerCopyRights">
                        <p>All right reserved ©More Blogs -{new Date().getFullYear()}.<br className="lg:hidden" /> Design and developed by <a href="https://atiqur.pages.dev/"><b>Atiqur Rahman</b></a></p>
                    </aside>
                </div>
            </div>
        </footer>
