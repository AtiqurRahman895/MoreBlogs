...
const TopScrollBar = ({ blogCount }) => {
  ...
  const [categoryList, setCategoryList] = useState([ "All","Creative", "Lifestyle", "Travel", "Fashion", "Nature", "Personal Finance",]);
  ...
  return (
    <div className="allBlogsTopScrollBar space-y-6">
      ...
      <div className="flex justify-center">
        <div className="flex gap-2 items-center overflow-x-scroll hide-scrollbar rounded-sm ">
            <button
                tabIndex={0}
                type="button"
